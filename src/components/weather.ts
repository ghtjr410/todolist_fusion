...
// OpenWeather API 키
const apiKey: string = "ef9a3fd7529b1bab7269f2b2e156973c";
...
export const setWeatherTheme = (description: string): void => {
...
export const fetchWeatherAndUpdateUI = async (): Promise<void> => {
    try {
