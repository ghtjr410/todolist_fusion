...
document.addEventListener("DOMContentLoaded", () => {
    ...
    const nameDisplay = document.getElementById('namePrompt');
    const inputBox = document.getElementById('inputNameBox');
    const inputTaskBox = document.getElementById('inputTaskBox');
    ...
    if (savedName) {
        ...
        if (savedTasks) {
            ...
            `;
                taskBox === null || taskBox === void 0 ? void 0 : taskBox.insertAdjacentHTML("beforeend", insertHTML);
                ////////////////////////////////
            });
        }
        else {
